...
- [ 22. Oracle APEX und AI](#oracle-apex-und-ai)
    ...
    - [22.1 Teil 2: Erstellen einer App mit Hilfe von AI in Oracle APEX](#erstellen-einer-app-mit-ai) 
        ...
        - [Schritt 6: Seitenübersicht anpassen](#schritt-seitenuebersicht-anpassen) 
    ...
    - [23. Oracle APEX und AI - RAG Daten](#oracle-apex-und-ai)
        - [Einleitung](#einleitung-ai)
            - [Schritt 1: Zugriff auf den App Builder](#schritt-zugriff-auf-den-app-builder)
            - [Schritt 2: Anlegen einer neuen Applikation](#schritt-anlegen-einer-neuen-applikation)
            - [Schritt 3: Zugriff auf Shared Components](#schritt-zugriff-auf-shared-components)
            - [Schritt 4: Zugriff auf AI Services](#schritt-zugriff-auf-ai-services)
            - [Schritt 5: Erstellen eines neuen AI Service](#schritt-erstellen-eines-neuen-ai-service)
            - [Schritt 6: Konfiguration des AI Service](#schritt-konfiguration-des-ai-service)
            - [Schritt 7: Erfolgreiche Erstellung und Rückkehr zu Shared](#schritt-erfolgreiche-erstellung-und-rückkehr-zu-shared-components)
            - [Schritt 8: Zugriff auf AI Configurations](#schritt-zugriff-auf-ai-configurations)
            - [Schritt 9: Erstellen einer neuen AI Configuration](#schritt-erstellen-einer-neuen-ai-configuration)
            - [Schritt 10: Konfigurieren der AI Configuration](#Konfigurieren-der-AI-Configuration)
            - [Schritt 11: Erstellen einer RAG Source](#schritt-erstellen-einer-rag-source)
            - [Schritt 12: RAG Source erstellen](#schritt-rag-source-erstellen)
            - [Schritt 13: Änderungen speichern und RAG Source bestätigen](#schritt-änderungen-speichern-und-rag-source-bestätigen)
            - [Schritt 14: Übersicht der AI Configurations und Erstellen](#schritt-übersicht-der-ai-configurations-und-erstellen-einer-neuen)
            - [Schritt 15: Erstellen einer neuen AI Configuration für Bestellauskünfte](#Erstellen-einer-neuen-AI-Configuration-für-Bestellauskünfte)
            - [Schritt 16: Erfolgreiches Speichern und RAG Source erstellen](#schritt-erfolgreiches-speichern-und-rag-source-erstellen)
            - [Schritt 17: RAG Source für Bestellauskünfte erstellen](#schritt-rag-source-für-bestellauskünfte-erstellen)
            - [Schritt 18: Erfolgreiches Speichern und Abschließen der RAG Source](#schritt-erfolgreiches-speichern-und-abschließen-der-rag-source)
            - [Schritt 19: Übersicht der erstellten AI Configurations und Wechsel zur App](#schritt-übersicht-der-erstellten-ai-configurations-und-wechsel-zur-app)
            - [Schritt 20: Login-Seite öffnen ](#schritt-login-seite-öffnen)
            - [Schritt 21: Anpassung der Login-Seite](#schritt-anpassung-der-login-seite)
            - [Schritt 22: Button zur KI-gestützten Artikelsuche hinzufügen](#schritt-button-hinzufügen)
            - [Schritt 23: Subregion "Artikel Report" erstellen](#schritt-subregion-erstellen)
            - [Schritt 24: Überprüfung der Login-Seite ](#schritt-überprüfung-der-login-seite)
            - [Schritt 25: Integration des InfoBots ](#schritt-integration-des-info-bots)
            - [Schritt 26: Interaktion mit dem InfoBot](#schritt-interaktion-mit-dem-info-bot)
        - [Teil 2: Kundenindividuelle Bestellauskunft mit KI](#kundenindividuelle-bestellauskunft)
            - [Schritt 1: Login-Seite anpassen](#schritt-login-seite-anpassen)
            - [Schritt 2: Button für die Kundenanmeldung erstellen](#schritt-kundenanmeldung-button-erstellen)
            - [Schritt 3: Login-Prozess für Kunden anpassen](#schritt-login-prozess-anpassen)
            - [Schritt 4: Kundenanmeldung testen](#schritt-kundenanmeldung-testen)
            - [Schritt 5: Anmeldebestätigung](#schritt-anmeldebestätigung)
            - [Schritt 6: Kundenbestellungen auf der Startseite anzeigen](#schritt-kundenbestellungen-anzeigen)
            - [Schritt 7: KI-Button zur Bestellabfrage hinzufügen](#schritt-ki-button-hinzufügen)
            - [Schritt 8: Dynamische Aktion für den KI-Button erstellen](#schritt-dynamische-aktion-für-ki-button)
        - [Abschluss: Bestellauskunft per KI](#abschluss-der-bestellauskunft-per-ki)
    - [23. JSON-Daten in Oracle APEX nutzen](#oracle-apex-und-json)
        - [Einleitung](#einleitung-json)
            - [Schritt 1: SQL Workshop öffnen und JSON-Daten vorbereiten](#schritt-sql-workshop-json) 
            - [Schritt 2: JSON-Daten abfragen](#schritt-json-daten-abfragen) 
            - [Schritt 3: JSON-Werte extrahieren](#schritt-json-werte-extrahieren) 
            - [Schritt 4: JSON-Datenquelle erstellen](#schritt-json-datenquelle-erstellen) 
            - [Schritt 5: Neue JSON-Datenquelle erstellen](#schritt-neue-json-datenquelle-erstellen) 
            - [Schritt 6: JSON-Datenquelle konfigurieren](#schritt-json-datenquelle-konfigurieren) 
            - [Schritt 7: JSON-Spalte auswählen](#schritt-json-spalte-auswählen) 
            - [Schritt 8: Datenprofil überprüfen](#schritt-datenprofil-überprüfen) 
            - [Schritt 9: Datenprofil fertigstellen](#schritt-datenprofil-fertigstellen) 
            - [Schritt 10: JSON Source erfolgreich erstellt](#schritt-json-source-überprüfen) 
            - [Schritt 11: Neue Seite erstellen](#schritt-neue-seite-erstellen) 
            - [Schritt 12: Classic Report definieren](#schritt-classic-report-definieren) 
            - [Schritt 13: JSON Report überprüfen und Spalten öffnen](#schritt-json-report-überprüfen) 
            - [Schritt 14: Spalten sortieren und ausblenden](#schritt-spalten-sortieren) 
            - [Schritt 15: Ergebnisprüfung](#schritt-ergebnisprüfung) 
            - [Abschluss](#abschluss-json)  
    - [23. Database Object Dependencies](#oracle-apex-und-dependencies)
        - [Einleitung](#einleitung-dependencies)
            - [Schritt 1: Applikation öffnen und zu den Utilities navigieren](#schritt-1-applikation-oeffnen)  
            - [Schritt 2: Database Object Dependencies öffnen](#schritt-2-dependencies-oeffnen)  
            - [Schritt 3: Anwendung scannen](#schritt-3-analyse-starten)  
            - [Schritt 4: Scan-Optionen wählen und starten](#schritt-4-scan-optionen-waehlen)  
            - [Schritt 5: Ergebnisse analysieren](#schritt-5-ergebnisse-analysieren)  
            - [Fazit](#oracle-apex-und-dependencies-fazit)  
...
# <a name="ai-basierte-artikelgenerierung"></a>22.2 AI-basierte Artikelgenerierung für Webshops (fortgeschrittener Workshop)
